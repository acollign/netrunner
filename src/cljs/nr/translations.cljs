...
(def translation-dictionary
  ...
  :fr
   {:missing ":fr texte manquant"
    ...
    {:title "Joue à Netrunner dans ton navigateur"
     ...
     :delete-all "Effacer tous les messages de l'utilisateur·trice"
    ...
    {:loading-msg "Chargement de la bibliothèque de decks…"
     :new-corp "Créer deck Corpo"
     :new-runner "Créer deck Runner"
   ...
   :lobby
    {:no-games "Aucune partie"
     ...
     :format "Format"
     :options "Options"
     :spectators "Autoriser les spectateur·trices"
     :hidden "Rendre les informations cachées visibles aux spectateur·trices"
     ...
     :too-little-data "Données insuffisantes"
     ...
     :singleton "Singleton"
     :timed-game "Démarrer la partie avec minuteur"
   ...
   {:invalid-password "Identifiant ou mot de passe invalide"
    ...
    :get-log-width "Obtenir la largeur actuelle du journal de partie"
    :get-log-top "Obtenir la hauteur actuelle du journal de partie"
    ...
    :runner-layout "Disposition des cartes du Runner du point de vue de la Corpo"
    ...
    :set-all "Appliquer aux cartes les illustrations de :"
    :set "Appliquer"
    :reset "Rétablir toutes les illustrations officielles"
    :blocked "Utilisateur·trices bloqué·es"
    ...
    :player-stats-icons "Afficher des icônes pours les stats des joueur·euses"
  ...
  {:game-log "Journal de partie"
   ...
   :settings "Réglages"}
  :annotations
  {:remote-annotations-fail "Impossible de récupérer les annotations distantes"
  ...
  {:keep "Garder"
   ...
   :unmute "Réactiver le son des spectateur·trices"
   :mute "Désactiver le son des spectateur·trices"
   :concede "Abandonner"
   :inactivity "Partie fermée pour cause d'inactivité"
   :server "Serveur"
  ...
  {:alt-art "Illustrations alternatives"
   :card-backs "Dos des cartes"
   :card-images "Images des cartes"
   :card-stacking "Empilement des cartes"
   :sort-archives "Trier les cartes dans les Archives"
   :card-sorting "Tri des cartes"
   :sort-heap "Trier les cartes dans le Tas"
   :label-faceup-cards "Étiqueter les cartes face visible"
   :label-unrezzed-cards "Étiqueter les cartes non activées"
   :high-res "Activer les images de carte en haute résolution"
   :preview-zoom "Vue de la carte agrandie"
   :runner-board-order "Disposition des cartes du Runner du point de vue de la Corpo"
   :runner-classic "classique"
   :runner-reverse "inversée"
   :save "Sauvegarder"
